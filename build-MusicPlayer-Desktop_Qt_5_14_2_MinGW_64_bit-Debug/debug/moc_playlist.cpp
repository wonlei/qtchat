...
QT_MOC_LITERAL(4, 36, 15), // "playModeChanged"
QT_MOC_LITERAL(5, 52, 8), // "PlayMode"
QT_MOC_LITERAL(6, 61, 4) // "mode"

    },
    "PlayList\0currentIndexChanged\0\0index\0"
    "playModeChanged\0PlayMode\0mode"
};
...
void PlayList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->playModeChanged((*reinterpret_cast< PlayMode(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayList::currentIndexChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PlayList::*)(PlayMode );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayList::playModeChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void PlayList::playModeChanged(PlayMode _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
